...
- # Mobile (Deep Specification)
	...
	- ## Commands
		...
		- **`mobile:squad-docs`**: Deeply document mobile screens, widgets, navigation, and state stores in the active workspace. (ref: `mobile/commands/mobile/squad-docs.toml`)
		- **`mobile:analyze`**: Read-only behavioral simulation. Traces widget tree rebuild paths, Dart null-safety conditions, BLoC/Riverpod state transitions, and async stream behavior against real or hypothetical data data inputs. No artifacts, no implementation. (ref: `mobile/commands/mobile/analyze.toml`, `common/skills/investigation.md`)
