...
- # Frontend (Deep Specification)
	...
	- ## Commands
		...
		- **`frontend:squad-docs`**: Deeply document frontend screens, components, user journeys, and state stores in the active workspace. (ref: `frontend/commands/frontend/squad-docs.toml`)
		- **`frontend:analyze`**: Read-only behavioral simulation. Traces component rendering paths, state mutations, and conditional display logic against real or hypothetical data data inputs. No artifacts, no implementation. (ref: `frontend/commands/frontend/analyze.toml`, `common/skills/investigation.md`)
