...
* [**Standardized Pipeline (Master)**](./use_cases/software_engineering_lifecycle.md): Move from vague idea to production code using the sequential **Brainstormer -> Architect -> Developer** pipeline.
* [**PRD Generation (Brainstormer)**](./use_cases/n8n_workflow_automation.md): Transform chaotic requirements into high-fidelity Product Requirements Documents.
* [**Regulatory & Compliance Audit**](./use_cases/regulatory_compliance_audit.md): Audit codebase against global standards (GDPR, HIPAA, SOC2).
* [**Security Infrastructure Audit**](./use_cases/security_audit.md): Multi-layered vulnerability scans with prioritized remediation roadmaps.
* [**Universal Skill Injection**](./use_cases/research_information_synthesis.md): Instantly upgrade any LLM (Claude/Gemini) with your private engineering knowledge base.
